    ...
    <div class="w-full ">
        ...
        <div class="w-full pt-20 pb-10 | lg:pt-32 lg:pb-16 | xl:pt-40">
            <div class="px-2 | sm:px-6 | xl:px-12 | 2xl:px-20 | 3xl:px-40 | 4xl:px-60">
                <div class="w-full flex flex-wrap justify-between relative z-10">
                    <div class="px-2 | lg:px-3 | xl:px-4 w-full | lg:w-6/16">
                            ...
                            <div class="flex flex-col space-y-3 | lg:space-y-5 items-start">
                                <div class="inline-flex items-center space-x-2  ">
                                    ...
                                    <div
                                        ...
                                        The boring legal stuff</div>
                                </div>
                                <h2
                                    class="text-2-5xl | md:text-3xl | lg:text-4xl | 2xl:text-6xl | 4xl:text-7xl font-sans-primary tracking-tight text-gray-600  | dark:text-grayDark-100 leading-none text-balance ">
                                    Privacy Policy</h2>
                            </div>
                        </div>
                    </div>
                    <div class="px-2 | lg:px-3 | xl:px-4 w-full pt-12 | lg:w-10/16 | xl:w-9/16">
                        <div class="w-full relative ">
                            ...
                            <h3
                                class="mb-3 text-pretty tracking-tight text-gray-600 | dark:text-grayDark-100 text-xl lg:text-2xl leading-tighter 4xl:text-3xl">
                                Interpretation</h3>
                            <p
                                class="text-base | xl:text-md text-gray-600 dark:text-grayDark-200 font-sans-primary relative z-10 text-pretty font-light leading-7  mb-6">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p
                                        ...
                                        Scalify, in5 Tech, Dubai Intercity Station, Dubai, UAE.
                                    </p>
                                </li>
                                <li>
                                    <p
                                ...
                                <li>
                                    <p
                                        class="text-base | xl:text-md text-gray-600 dark:text-grayDark-200 font-sans-primary relative z-10 text-pretty font-light leading-7  mb-6">
                                        <strong>Website</strong> refers to Scalify, accessible from <a
                                            href="https://scalify.ae" rel="external nofollow noopener"
                                            target="_blank">https://scalify.ae</a>
                                    </p>
                                </li>
                                <li>
                                    <p
                            ...
                            <h4
                                class="mb-3 text-pretty tracking-tight text-gray-600 | dark:text-grayDark-100 text-xl leading-tighter 4xl:text-2xl">
                                Personal Data</h4>
                            <p
                                class="text-base | xl:text-md text-gray-600 dark:text-grayDark-200 font-sans-primary relative z-10 text-pretty font-light leading-7  mb-6">
                            ...
                            <p
                                ...
                                cookies on <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies"
                            ...
                            <ul>
                                <li>
                                    <p
                                        class="text-base | xl:text-md text-gray-600 dark:text-grayDark-200 font-sans-primary relative z-10 text-pretty font-light leading-7  mb-6">
                                        By email: hello@scalify.ae</p>
                                </li>
                                <li>
                                    <p
                                        class="text-base | xl:text-md text-gray-600 dark:text-grayDark-200 font-sans-primary relative z-10 text-pretty font-light leading-7  mb-6">
                                        By visiting this page on our website: <a href="httsp://scalify.ae/contact"
                                            rel="external nofollow noopener"
                                            target="_blank">httsp://scalify.ae/contact</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<!-- Served by Blitz on 2025-08-19T03:18:32+01:00 -->